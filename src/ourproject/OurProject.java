...
public class OurProject extends Application {
    ...
    public void start(Stage primaryStage) {
        ...
        Main.ranking.setOnAction((ActionEvent e) -> {
            System.out.println("ranking will open");
        });
        ...
        Main.exit.setOnAction((ActionEvent e) -> {
            ...
            exit = new ExitAndcongrats(false, true, true); // exit window
        ...
        playground.Back.setOnMouseClicked((MouseEvent e) -> {
            ...
            GameBoard gameboard;
            try {
                gameboard = new GameBoard(num,players, 2,Choose.getplayer1coin());
                third.close();
              ...
              // Logger.getLogger(SnakeAndLadders.class.getName()).log(Level.SEVERE, null, ex);
           }
        });
        playground.Back1.setOnMouseClicked((MouseEvent e) -> {
           String[] players = new String[2]; 
            ...
            GameBoard gameboard;
            try {
                gameboard = new GameBoard(num, players, 1,Choose.getplayer1coin());
            third.close();
            fourth.setTitle("Let's Play The Game");
            fourth.setScene(gameboard.getScene());
            fourth.setResizable(false);
